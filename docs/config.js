...
export const CFG = {
  ...
  ANIMALS: {
    small: { emoji: "🐇", tiles: new Set(["⬜️", "🌿"]), passive: true, hp: 1, atk: 0, name: "Заяц", loot: { food: [1, 1] } },
    big: { emoji: "🦌", tiles: new Set(["🌳", "🌲", "🌿"]), passive: true, hp: 2, atk: 0, name: "Олень", loot: { food: [1, 2] } },
    boar: { emoji: "🐗", tiles: new Set(["🌳", "🌲", "🌿"]), passive: true, hp: 2, atk: 1, name: "Кабан", loot: { food: [1, 2] } },
    wolf: { emoji: "🐺", tiles: new Set(["🌳", "🌲", "🌿"]), passive: false, hp: 8, atk: 2, name: "Волк", loot: { food: [2, 3], gold: [0, 1], special: 0.1 }, effectOnHit: { bleeding: 0.3 } },
    eagle: { emoji: "🦅", tiles: new Set(["🗿", "⛰️", "🌋"]), passive: false, hp: 2, atk: 1, name: "Орёл", loot: { food: [1, 1], special: 0.05 } },
    maxCount: 6,
  },
  NPCS: {
    "🧝🏿": { name: "Тёмный эльф", tiles: new Set(["🌳", "🌲", "🌿"]), atk: 2, hp: 7, dodgeChance: 0.2, loot: { gold: [2, 4], special: 0.2 }, effectOnHit: { poison: 0.15 } },
    "🧑🏾‍🌾": { name: "Заражённый фермер", tiles: new Set(["⬜️"]), atk: 1, hp: 4, spawnChance: 0.6, loot: { gold: [0, 2], food: [0, 1] }, effectOnHit: { poison: 0.3 } },
    "🧙🏾‍♀️": { name: "Безумный маг", tiles: new Set(["🗿", "⛰️", "🌋"]), atk: 3, hp: 5, attacksFirst: true, loot: { gold: [3, 6], special: 0.25 }, effectOnHit: { fear: 0.2 }, boss: true },
  },
  LOOT_SPECIAL: ["💉", "🧪", "🗡️", "🛡️", "🌿"],
  STATUS_EFFECTS: {
